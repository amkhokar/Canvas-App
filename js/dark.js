...
(function () {
  ...
  const stories = {
    ...
    Chapter3ANarrate: "Along Kenneth’s Journey, he met Samantha and fell in love from 0-100. “I’ve never met a strong beautiful woman like you. You make me feel some type of way.” Samantha live as an average person in Epicodus. She won the jackpot if she’ll marry the future prince of Epicodus. But for Kenneth, his parents’ standards are beyond the expectations. There is no way that they will get married with they approval. Hence, they need to keep the situation private",
    ...
    Chapter4A: " Kenneth professed his love to Samantha and asked his father, Dudu for a blessing. The king rejected the offer and has gon crazy to hear the hasty decision. Kenneth and Samantha have been outcasted, breaking the rules of their bloodline and as well as the Kingdom’s commandment",
    ...
    Chapter5A: "The prophecy has come, and the city of Epicodus starts to fall apart. Chaos are everywhere and people are dying. Kenneth felt despair and hopeless and has been swallowed in fear. He fled Epicodus with Samantha. Kenneth failed to save Epicodus and be the Ruler Prince. He relocated to CodeFellows and started a new life with Samantha and leave the past behind. END.",
  ...
  let currentText = stories.Chapter1B;
  ...
  pick2C = function () {
    ...
    space.add({
      animate: (time, ftime) => {
        ...
        form.fill("#123");
        form.alignText("center").paragraphBox(rect, stories.Chapter2C, 2.5, "middle");
      }
    });
  }

  pick2D = function () {
    currentText = stories.Chapter2D;
    $('#1B-2C').hide();
    $('#1B-2D').hide();
    $('#2D-3B').show();
    space.add({
      animate: (time, ftime) => {
        ...
        form.fill("#fff").stroke("#0ca", 1).rect(rect);
        form.fill("#123");
        form.alignText("center").paragraphBox(rect, stories.Chapter2D, 2.5, "middle");
      }
    });
  }
  pick3B = function () {
    ...
    space.add({
      animate: (time, ftime) => {
        ...
        form.fill("#fff").stroke("#0ca", 1).rect(rect);
        form.fill("#123");
        form.alignText("center").paragraphBox(rect, stories.Chapter3B, 2.5, "middle");
      }
    });
  }
  pick4C = function () {
